				...
				<fieldset class="consent">
					{if $currentContext->getData('privacyStatement')}
						...
						<div class="fields">
							<div class="optin optin-privacy">
								<label>
									<input type="checkbox" name="privacyConsent" value="1" {if $privacyConsent}
										checked="checked" {/if}>
					...
					<div class="fields">
						<div class="optin optin-email">
							<label>
								<input type="checkbox" name="emailConsent" value="1" {if $emailConsent} checked="checked"
									{/if}>
				...
				{if $userCanRegisterReviewer}
					<fieldset class="reviewer">
						...
						<div class="fields">
							...
							<div id="reviewerInterests" class="reviewer-interests">
								<label>
									<span class="label">
